export default function Footer() {
    return <footer className="mt-auto w-full py-10 border-t border-gray-200 bg-[#1e5751]">
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-5">
      <ul>
        <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
          <a className="inline-flex gap-x-2 text-sm text-white hover:text-gray-200 focus:outline-none focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">
          Our Story
          </a>
        </li>
        <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
      ...
      <div className="text-center">
        <p className="text-sm text-white hover:text-gray-200">Delivery info</p>
      </div>
